...
const authMiddleman = (req, res, next) => {
  ...
  //   if the header is missing or doesnt start with "Bearer ", reject the request
  ...
  try {
    // Verify the token using the secret key; throw an error meessage if invalied or expired
